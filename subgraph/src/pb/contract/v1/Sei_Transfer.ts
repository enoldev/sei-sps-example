...
export class Sei_Transfer {
  static encode(message: Sei_Transfer, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Sei_Transfer {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Sei_Transfer();
