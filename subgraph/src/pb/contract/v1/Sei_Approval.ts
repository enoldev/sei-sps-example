...
export class Sei_Approval {
  static encode(message: Sei_Approval, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Sei_Approval {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Sei_Approval();
