...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct BankPrecompile {}
    impl BankPrecompile {
        const METHOD_ID: [u8; 4] = [86u8, 103u8, 50u8, 193u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for BankPrecompile {
        const NAME: &'static str = "BankPrecompile";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for BankPrecompile {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct Ddecimals {}
    impl Ddecimals {
        const METHOD_ID: [u8; 4] = [168u8, 173u8, 17u8, 228u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Ddecimals {
        const NAME: &'static str = "ddecimals";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    pub struct Denom {}
    impl Denom {
        const METHOD_ID: [u8; 4] = [195u8, 112u8, 176u8, 66u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Denom {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for Denom {
    ...
    pub struct Nname {}
    impl Nname {
        const METHOD_ID: [u8; 4] = [138u8, 9u8, 137u8, 245u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Nname {
        const NAME: &'static str = "nname";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for Nname {
        fn output(data: &[u8]) -> Result<String, String> {
            Self::output(data)
        }
    }
    ...
    pub struct Ssymbol {}
    impl Ssymbol {
        const METHOD_ID: [u8; 4] = [158u8, 16u8, 170u8, 36u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Ssymbol {
        const NAME: &'static str = "ssymbol";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for Ssymbol {
        fn output(data: &[u8]) -> Result<String, String> {
            Self::output(data)
        }
    }
